...
exports.deleteFile = exports.listImages = exports.thumbnailExists = void 0;
...
var listImages = function () { return __awaiter(void 0, void 0, void 0, function () {
    var imagesPath, files, images, imagesName, _i, images_1, image, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                imagesPath = path_1.default.join(__dirname, '..', 'images', 'original');
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, promises_1.readdir)(imagesPath, { withFileTypes: true })];
            case 2:
                files = _a.sent();
                images = files.filter(function (file) { return !file.isDirectory(); });
                imagesName = [];
                for (_i = 0, images_1 = images; _i < images_1.length; _i++) {
                    image = images_1[_i];
                    imagesName.push(image.name);
                }
                return [2 /*return*/, imagesName];
            case 3:
                error_1 = _a.sent();
